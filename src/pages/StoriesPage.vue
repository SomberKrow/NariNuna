...
<template>
  ...
  <section class="memory-album room-section page-width" aria-labelledby="album-title">
    ...
    <ol class="memory-album__pages">
      <li v-for="(moment, index) in featuredMoments" :key="moment.id">
        <div class="memory-album__folio"><span>Moment 0{{ index + 1 }}</span><span aria-hidden="true">Nari's Haven</span></div>

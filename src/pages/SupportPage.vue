...
const ways: { icon: typeof Eye; title: string; text: string; ghostie: GhostieVariant }[] = [
  { icon: Eye, title: "Just be here", text: "Watch, lurk, laugh, or take a break. You never need to perform to deserve your place.", ghostie: "welcome" },
  { icon: Share2, title: "Share a favorite moment", text: "Send a clip to somebody who needs a laugh. Genuine little moments mean a lot.", ghostie: "share" },
  { icon: Heart, title: "Be good to the room", text: "Kindness, respect, and healthy boundaries help everyone in the Haven breathe.", ghostie: "kindness" }
];
</script>
  ...
  <section class="support-kindness page-width section-pad">
    ...
    <div class="support-kindness__grid support-kindness__grid--painted">
      <article v-for="way in ways" :key="way.title">
        <GhostieIllustration class="ghostie-card-art" :variant="way.ghostie" />
...
.ghostie-card-art { height: 11.5rem; border-bottom: 1px solid var(--story-line); border-radius: 0; }
...
@media (min-width: 48rem) {
  ...
  .ghostie-card-art { height: 12.5rem; }
}
</style>

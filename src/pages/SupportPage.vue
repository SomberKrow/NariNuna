...
const ways = [
  { icon: Eye, title: "Just be here", text: "Watch, lurk, laugh, or take a break. You never need to perform to deserve your place.", art: storybookPostcards.home },
  { icon: Share2, title: "Share a favorite moment", text: "Send a clip to somebody who needs a laugh. Genuine little moments mean a lot.", art: storybookPostcards.streams },
  { icon: Heart, title: "Be good to the room", text: "Kindness, respect, and healthy boundaries help everyone in the Haven breathe.", art: storybookPostcards.haven }
];
</script>
  ...
  <section class="support-kindness page-width section-pad">
    ...
    <div class="support-kindness__grid support-kindness__grid--painted">
      <article v-for="way in ways" :key="way.title">
        <img :src="way.art" width="640" height="360" alt="" loading="lazy" />

...
<template>
  ...
  <section class="kindness-notes room-section page-width" aria-labelledby="kindness-title">
    <header class="room-heading"><div><p class="room-kicker">The things that cost nothing</p><h2 id="kindness-title">Little things.<br /><em>A whole lot of meaning.</em></h2></div></header>
    <div class="kindness-notes__wall">
      <article v-for="way in ways" :key="way.title">
        <GhostieArt class="kindness-notes__ghostie" sizes="(min-width: 48rem) 160px, 112px" :variant="way.ghostie" :mirror="way.mirror" />
...
<style scoped lang="scss" src="@/styles/rooms/support.scss"></style>

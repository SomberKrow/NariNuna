...
.haven-values__ghostie { --ghostie-size: 11rem; height: 11.5rem; border-bottom: 1px solid var(--story-line); border-radius: 0; }
...
@media (min-width: 48rem) {
  ...
  .haven-values__ghostie { --ghostie-size: 12rem; height: 12.5rem; }

...
> **Current implementation snapshot:** 9 September 2026, `main` at `c763366` after merged PR #16, plus the `kiva/mobile-refinement-pass-2` review branch. See [mobile changes and validation](docs/35_MOBILE_FIRST_OVERHAUL.md).
